...
export function addVisualToLink(
  urdfContent: string,
  linkName: string,
  ...
  const visual = xmlDoc.createElement("visual");
  ...
  // Add material if color provided
  if (materialColor) {
    const material = xmlDoc.createElement("material");
