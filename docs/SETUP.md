...
Blender, Genesis, PyBullet, and simulator containers are optional profiles. The base app remains usable if an optional target runtime cannot be installed on the current laptop.
