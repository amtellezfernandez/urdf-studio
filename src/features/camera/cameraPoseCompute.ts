 ...
 */
export function computeLinkBoundingBox(robot: any, linkName: string): THREE.Box3 | null {
 ...
 */
export function autoComputeCameraPoseDefault(robot: any, parentLink: string): CameraPoseConfig | null {
