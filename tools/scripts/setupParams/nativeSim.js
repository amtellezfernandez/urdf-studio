export const NATIVE_SIM_SETUP = {
  ...
  mjxDependencies: ['mujoco-mjx==3.9.0'],
  verifyImportScript: [
    'import importlib',
    ...
    'for module_name in ("jax_dataclasses", "jaxlie", "jaxls", "mujoco", "mujoco.mjx"):',
...
export const MJX_DEPENDENCIES = NATIVE_SIM_SETUP.mjxDependencies;
