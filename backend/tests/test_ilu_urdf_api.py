...
def test_gallery_job_endpoints_expose_generation_and_pr_actions(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        ...
        lambda payload: IluGalleryJobResponse(
            ...
            repo_metadata={"org": "", "summary": "", "demo": "", "tags": [], "license": "", "authorWebsite": "", "authorX": "", "authorLinkedin": "", "authorGithub": "", "contact": "", "extra": ""},
            items=[],
            error=None,
    ...
    monkeypatch.setattr(
        ...
        lambda job_id: IluGalleryJobResponse(
            ...
            repo_metadata={"org": "Acme Robotics", "summary": "Compact demo arm", "demo": "", "tags": ["Arm"], "license": "Apache-2.0", "authorWebsite": "https://acme.example", "authorX": "", "authorLinkedin": "", "authorGithub": "acme", "contact": "", "extra": ""},
            items=[
                {
                    "id": "demo",
                    "title": "Demo",
