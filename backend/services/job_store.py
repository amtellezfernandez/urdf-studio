...
class JobStore:
    ...
    async def initialize(self) -> None:
        ...
        with self._connect() as db:
            ...
            db.execute("CREATE INDEX IF NOT EXISTS idx_jobs_model ON jobs (model_architecture)")
            db.execute("CREATE INDEX IF NOT EXISTS idx_metrics_job ON metrics (job_id)")
            db.execute("CREATE INDEX IF NOT EXISTS idx_metrics_step ON metrics (job_id, step)")
    ...
    async def delete_job(self, job_id: str) -> bool:
        ...
        with self._connect() as db:
            ...
            db.execute("DELETE FROM metrics WHERE job_id = ?", (job_id,))

            # Delete job
            cursor = db.execute("DELETE FROM jobs WHERE job_id = ?", (job_id,))
            db.commit()
