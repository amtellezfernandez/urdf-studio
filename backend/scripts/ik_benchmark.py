...
from backend.services.kinematics import forward_kinematics as pyroki_fk
...
def main() -> None:
    ...
    parser.add_argument("--solvers", nargs="*", default=["pyroki-http", "lerobot-placo"])
    ...
    if "pyroki-http" in args.solvers:
        results.append(evaluate_pyroki(urdf_xml, target_link, targets))
