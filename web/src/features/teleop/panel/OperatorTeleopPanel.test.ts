...
const TEST_PROVIDER_JOINT_LIMITS = {
  defaultJointJogStepRad: 0.01,
  maxJointVelocityRadPerSec: 0.5,
  none: 0,
} as const;
const TEST_OPENARM_LEADER_TELEMETRY = {
  positionRad: 0.35,
} as const;
const TEST_CALIBRATION_ZERO_OVERRIDES = {
  shoulderPanRad: 0.35,
  elbowFlexRad: -0.2,
} as const;
const TEST_CALIBRATION_REVISION = 2;
const TEST_CALIBRATION_INITIAL_REVISION =
  OPERATOR_LEROBOT_CALIBRATION_FILE_SYNC_REVISION_INITIAL;
const TEST_CALIBRATION_SESSION_ID = 1;
const TEST_LEADER_TARGET_DIRECTION = 1;
const TEST_SHOULDER_MOTOR_ID = 3;
const TEST_ELBOW_MOTOR_ID = 1;
const TEST_CAMERA_FIXTURE = {
  widthPx: 48,
  heightPx: 32,
  focalPx: 46,
  principalPointPx: 24,
...
const TEST_LIVE_RELAY_URL = "https://relay.test";
const TEST_LIVE_NAMESPACE = "robot-gateway/openarm";
const TEST_CAMERA_POSE = {
  position: [0.3, 0, 0],
  rotationRpyDeg: [0, 0, 0],
  scale: 0.001,
  worldFrame: "urdf_z_up",
} as const;
const TEST_CAMERA_CONFIG_POSE = {
  position: [...OPENARM_HF_LIVE_REAL_SENSE_POSITION_M],
  rotationRpyDeg: [...OPENARM_HF_LIVE_REAL_SENSE_ROTATION_RPY_DEG],
  scale: 0.001,
  worldFrame: "urdf_z_up",
} as const;
const TEST_CAMERA_STREAM = {
...
const TEST_PROVIDER_PROFILE: OperatorTeleopProfile = {
