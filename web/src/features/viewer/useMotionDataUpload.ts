      ...
      reader.onload = async (e) => {
        ...
        let sourceFrames:
          | {
              ...
              base_pose?: AnimationFrame["basePose"];
            }[]
          | undefined;
        ...
        const frames: AnimationFrame[] = sourceFrames.map((frame) => {
          ...
          return {
            ...
            joints: mapped,
            basePose: cloneRobotBasePose(frame.base_pose),
          };
        });
        ...
        if (robot && frames.length > 0) {
          ...
          applyJointValues(robot, firstFrame.joints, { filter: false });
          applyRobotBasePose(robot, firstFrame.basePose);
          setStoreJointValues(firstFrame.joints);
        }
