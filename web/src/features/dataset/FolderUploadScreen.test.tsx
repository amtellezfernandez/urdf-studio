...
const TEST_GITHUB_RESOLVED_SOURCE = `https://github.com/${TEST_GITHUB_OWNER}/${TEST_GITHUB_REPO}/tree/${TEST_GITHUB_BRANCH}`;
...
const TEST_OPENARM_CAMERA_CONFIG_BODY = JSON.stringify({
  cameras: [
    {
